                    ...
                    <ul id="sidebarnav" style="background-color:#ffecb3;">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?= base_url() ?>ManajemenResep" aria-expanded="false">
                                ...
                                <span class="hide-menu" style="color:#aa5806; font weight:bold;">Manajemen Resep</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?= base_url()?>User" aria-expanded="false">
                                <i class="fa fa-user" aria-hidden="true"></i>
                                <span class="hide-menu" style="color:#aa5806; font weight:bold;">Manajemen User</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                        ...
                        <li class="sidebar-item" style="text-align: center;">
                                ...
                                <a href="http://"><span class="hide-menu" style="color:#aa5806; font weight:bold;">Logout</span></a>
                        </li>
                    </ul>
