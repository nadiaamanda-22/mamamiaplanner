        <aside class="left-sidebar" data-sidebarbg="skin6" style="background-color:#ffecb3;">
            <!-- Sidebar scroll-->
            <div class="scroll-sidebar">
                <!-- Sidebar navigation-->
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" style="background-color:#ffecb3;">
                        <!-- User Profile-->
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?= base_url() ?>ManajemenResep" aria-expanded="false">
                                ...
                                <span class="hide-menu" style="color:#aa5806; font-weight:bold;">Resep</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?= base_url() ?>ManajemenUser" aria-expanded="false">
                                <i class="fa fa-user" aria-hidden="true"></i>
                                <span class="hide-menu" style="color:#aa5806; font-weight:bold;">User</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?= base_url() ?>ManajemenBahan" aria-expanded="false">
                                ...
                                <span class="hide-menu" style="color:#aa5806; font-weight:bold;">Bahan</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?= base_url() ?>ManajemenLangkahMasak" aria-expanded="false">
                                ...
                                <span class="hide-menu" style="color:#aa5806; font-weight:bold;">Langkah Memasak</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?= base_url() ?>ManajemenJadwal" aria-expanded="false">
                                <i class="fa fa-calendar-alt" aria-hidden="true"></i>
                                <span class="hide-menu" style="color:#aa5806; font-weight:bold;">Jadwal</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?= base_url() ?>ManajemenDataLaporan" aria-expanded="false">
                                <i class="fa fa-file-alt" aria-hidden="true"></i>
                                <span class="hide-menu" style="color:#aa5806; font-weight:bold;">Data Laporan</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?= base_url() ?>ManajemenRequest" aria-expanded="false">
                                <i class="fa fa-file" aria-hidden="true"></i>
                                <span class="hide-menu" style="color:#aa5806; font-weight:bold;">Request</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?= base_url() ?>ManajemenForum" aria-expanded="false">
                                <i class="fa fa-users" aria-hidden="true"></i>
                                <span class="hide-menu" style="color:#aa5806; font-weight:bold;">Forum</span>
                            </a>
                        </li>
                        <li class="sidebar-item" style="text-align: center;">
                            <a href="http://"><span class="hide-menu" style="color:#aa5806; font-weight:bold;">Setting | </span></a>
                            <a href="<?= base_url()        ?>Auth/logout"><span class="hide-menu" style="color:#aa5806; font-weight:bold;">Logout</span></a>
                        </li>
                    </ul>
