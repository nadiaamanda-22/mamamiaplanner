...
<!--================Blog Area =================-->
                        ...
                        <div class="blog_left_sidebar">
                            <article class="blog_item">
                                <div class="blog_item_img">
                                    <img class="card-img rounded-0" src="<?php echo base_url()?>assets/img/slider/1.png" alt="">
                        ...
                        <div class="blog_right_sidebar">
                            <aside class="single_sidebar_widget search_widget">
                                <form action="#" class="kotaksearch">
                                    ...
                                    <button class="button rounded-0 primary-bg text-white w-100 btn_1 boxed-btn buttonsearch"
        ...
        <div class="fixed-action-btn buttonfix">
          ...
          <ul>
            <li><a href="<?php echo base_url() ?>request"class="btn-floating request"><i class="fas fa-concierge-bell"></i></a></li>
            <li><a href="#modal2" class="btn-floating upload modal-trigger"><i class="bi bi-upload"></i></a></li>
          </ul>
        </div>
