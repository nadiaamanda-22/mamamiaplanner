   ...
   <div class="container">
      ...
      <div class="row">
         <div class="col m4 s12">
            <div class="card menu">
               <div class="card-image waves-effect waves-block waves-light">
                  <img class="activator responsive-img" src="img/menu/orak_arik.jpg">
               </div>
               <div class="card-content">
                  <span class="card-title activator" style="font-weight: bold;">Orak Arik Telur Sayur
               ...
               <div class="card-reveal">
                  <span class="card-title grey-text text-darken-4">Orak Arik Telur Sayur<i
         ...
         <div class="col m4 s12">
            <div class="card menu">
               <div class="card-image waves-effect waves-block waves-light">
                  <img class="activator responsive-img" src="img/menu/terong.jpg">
               </div>
               <div class="card-content">
                  <span class="card-title activator" style="font-weight: bold;">Pecak Terong
                     <i class="material-icons right">more_vert</i>
                  </span>
                  <hr>
                  <p><button type="submit" href="#">Detail</button></p>
               ...
               <div class="card-reveal">
                  <span class="card-title grey-text text-darken-4">Pecak Terong<i
                        class="material-icons right">close</i></span>
                  <p>Bahan :</p>
               </div>
            </div>
         ...
         <div class="col m4 s12">
            <div class="card menu">
               <div class="card-image waves-effect waves-block waves-light">
                  <img class="activator responsive-img" src="img/menu/rice_box.jpg">
               </div>
               <div class="card-content">
                  <span class="card-title activator" style="font-weight: bold;">Ayam Saos Tiram
                     <i class="material-icons right">more_vert</i>
                  </span>
                  <hr>
                  <p><button type="submit" href="#">Detail</button></p>
               ...
               <div class="card-reveal">
                  <span class="card-title grey-text text-darken-4">Rice Box Ayam Saos Tiram<i
                        class="material-icons right">close</i></span>
                  <p>Bahan :</p>
               </div>
            </div>
         ...
         <div class="col m4 s12">
            <div class="card menu">
               <div class="card-image waves-effect waves-block waves-light">
                  <img class="activator responsive-img" src="img/menu/king_mangga.jpeg">
               </div>
               <div class="card-content">
                  <span class="card-title activator" style="font-weight: bold;">King Manggo Thai
                     <i class="material-icons right">more_vert</i>
                  </span>
                  <hr>
                  <p><button type="submit" href="#">Detail</button></p>
               ...
               <div class="card-reveal">
                  <span class="card-title grey-text text-darken-4">King Manggo Thai<i
                        class="material-icons right">close</i></span>
                  <p>Bahan :</p>
               </div>
            </div>
         ...
         <div class="col m4 s12">
            <div class="card menu">
               <div class="card-image waves-effect waves-block waves-light">
                  <img class="activator responsive-img" src="img/menu/yakult.jpg">
               </div>
               <div class="card-content">
                  <span class="card-title activator" style="font-weight: bold;">Lychee Yakult
                     <i class="material-icons right">more_vert</i>
                  </span>
                  <hr>
                  <p><button type="submit" href="#">Detail</button></p>
               ...
               <div class="card-reveal">
                  <span class="card-title grey-text text-darken-4">Lychee Yakult<i
                        class="material-icons right">close</i></span>
                  <p>Bahan :</p>
               </div>
            </div>
         ...
         <div class="col m4 s12">
            <div class="card menu">
               ...
               <div class="card-content">
                  <span class="card-title activator" style="font-weight: bold;">Manggo Lessi
                     <i class="material-icons right">more_vert</i>
                  </span>
                  <hr>
                  <p><button type="submit" href="#">Detail</button></p>
               ...
               <div class="card-reveal">
                  <span class="card-title grey-text text-darken-4">Manggo Lessi<i
                        class="material-icons right">close</i></span>
                  <p>Bahan :</p>
               </div>
            </div>
