                  ...
                  <form>
                     ...
                     <div class="row">
                        <div class="input-field col s10 email">
                           ...
                           <input placeholder="Username atau Email" id="nama" name="nama" type="text" class="validate"
                              required>
                        ...
                        <div class="row center">
                           <div class="col s12 center">
                              ...
                              <p class="reg center">Belum Punya Akun? <a href="<?php echo base_url()?>regis" class="here">Daftar
                                    Disini</a></p>
                           </div>
                        </div>
                     </div>
